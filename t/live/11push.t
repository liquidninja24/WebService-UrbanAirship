...

{
  ...
  ok (! $rc,
      'no rc for missing devices and aliases');
}
...

{
  ...
  my $test = '{"aps":{"alert":"the carrier rocks!","badge":3,"sound":"ping.caf"},"aliases":["three","four"],"device_tokens":["one","two"]}';
